  ...
  return (
    <>
      ...
      <section className="mt-10">
        <h2 className="font-mono text-2xs uppercase tracking-slate text-subtle">Running now</h2>
        {sponsors.length === 0 ? (
          <Card className="mt-3">
            ...
            {sponsors.map(({ slot, sponsor }) => (
              <Card key={slot.id}>
                <CardContent className="flex flex-wrap items-center justify-between gap-3 p-4">
                  ...
                  <span className="font-mono text-2xs uppercase tracking-slate text-signal">
