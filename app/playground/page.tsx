  ...
  return (
    <div className="min-h-[100dvh] bg-canvas text-foreground">
      ...
      <div className="border-b border-line-subtle bg-sunken">
        <div className="mx-auto max-w-narrow px-gutter py-2 font-mono text-2xs uppercase tracking-slate text-subtle">
      ...
      <header className="mx-auto flex max-w-narrow items-baseline gap-2 px-gutter py-6">
        ...
        <span className="font-mono text-2xs uppercase tracking-slate text-faint">/ travel</span>
      </header>
